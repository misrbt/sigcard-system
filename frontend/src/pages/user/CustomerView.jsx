        ...
        <div className="bg-gradient-to-r from-slate-900 via-blue-950 to-slate-900">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
            ...
            <div className="flex items-start gap-4">
              ...
              {!isReadOnly && (
                <button
                  onClick={() => navigate(`/users/customers/${customer.id}/edit`)}
                  className="flex-shrink-0 flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white text-sm font-semibold transition-colors"
                >
